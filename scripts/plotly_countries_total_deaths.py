...
df = pd.read_csv('../data/CONVENIENT_global_deaths.csv', index_col=0, header=[0,1])
...
fig.update_layout(
    ...
    title='Total number of Covid-19 deaths per 100k inhabitants',
    autosize=False,
    xaxis_title='Date',
...
fig.write_html('../plots/interactive/plotly_countries_total_deaths.html', include_plotlyjs='cdn')
fig.show()